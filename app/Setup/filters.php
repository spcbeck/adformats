...
add_filter('theme/index/sidebar/visibility', 'Pixability\Theme\App\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'Pixability\Theme\App\Setup\show_index_sidebar');
...
add_filter('excerpt_length', 'Pixability\Theme\App\Setup\modify_excerpt_length');
