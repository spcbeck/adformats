    ...
    <div class="wrapper">
        <div class="content">
                ...
                <div class="posts">
                    <?php while (have_posts()) : the_post() ?>
                        <?php
                             ...
                             *
                             * @hooked Pixability\Theme\App\Structure\render_post_thumbnail - 10
                             */
            ...
            <?php else : ?>
                <?php
                     ...
                     *
                     * @hooked Pixability\Theme\App\Structure\render_empty_content - 10
                     */
        ...
        <?php if (apply_filters('theme/index/sidebar/visibility', true)) : ?>
            <?php
                 ...
                 *
                 * @hooked Pixability\Theme\App\Structure\render_sidebar - 10
                 */
