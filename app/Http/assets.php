...
namespace Pixability\Theme\App\Http;
...
use function Pixability\Theme\App\asset_path;
...
add_action('wp_enqueue_scripts', 'Pixability\Theme\App\Http\register_stylesheets');
...
add_action('wp_enqueue_scripts', 'Pixability\Theme\App\Http\register_scripts');
...
add_action('admin_init', 'Pixability\Theme\App\Http\register_editor_stylesheets');
...
add_action('wp_default_scripts', 'Pixability\Theme\App\Http\move_jquery_to_the_footer');
